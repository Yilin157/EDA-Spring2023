...
```{r message=FALSE, warning=FALSE, echo=FALSE, fig.cap="Monthly Ozone, 2018", fig.align='left', fig.height= 2.8}
#factor(epa_data$Month, levels(1:12))
ozone2018<-ggplot(subset(epa_data, Year == "2018"),
...
print(ozone2018)
```
```{r message=FALSE, warning=FALSE, echo=FALSE, fig.cap="Monthly Ozone, 2019", fig.align='left', fig.height= 2.8}
ozone2019<-ggplot(subset(epa_data, Year == "2019"),
                  aes(x=factor(Month, levels = 1:12, labels = month.abb),y= Ozone))+
  geom_boxplot()+
  labs(x= "Month",
       y= expression(paste('Concentration (',mu,'g/',m^3,')')),
...
### Git Repository
https://github.com/Yilin157/EDA-Spring2023.git
