...
NTL.phys.data.exercise4<-NTL.phys.data.exercise3 %>%
  filter(depth == 0) %>% 
...
NTL.phys.data.exercise5 <- pivot_longer(NTL.phys.data,irradianceWater:irradianceDeck, names_to = "Irradiance_Type", values_to = "Irradiance_Value")
